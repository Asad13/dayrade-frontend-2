...
const Headerpro = memo((props) => {
  ...
  //optimized code
  const route = IndexRouters.slice(6)
          ...
          >
            <div className="offcanvas-body">
              <ul className="iq-nav-menu list-unstyled">
                    ...
                    >
                      ...
                      <Nav.Item as="li">
                        <Link
                          ...
                          to="/dashboard/alternate-dashboard"
                        >
                          Alternate Dashboard
                        </Link>
                      </Nav.Item>
                  ...
                  <Collapse in={open2}>
                    ...
                    >
                      <Nav.Item as="li">
                        <Nav.Link
                          className={`${
                            subActiveLink === 'SpecialPages' ? 'active' : ''
                          } menu-arrow`}
                ...
                <Nav.Item
                  as="li"
                  className={`${ActiveLink === 'elements' ? 'active' : ''}`}
                >
                  <Nav.Link
                    className="menu-arrow justify-content-start"
        ...
        >
          <ul className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
            ...
            <Dropdown as="li" className="nav-item">
              <Dropdown.Toggle as={CustomToggle} variant="nav-link ps-3 pe-2">
              ...
              <Dropdown.Menu variant="end p-0 sub-drop iq-dropdown">
            ...
            <Dropdown as="li" className="nav-item">
              ...
              <Dropdown.Menu variant="end">
                ...
                <Dropdown.Item onClick={() => history('/auth/sign-in')}>
                  Logout
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
