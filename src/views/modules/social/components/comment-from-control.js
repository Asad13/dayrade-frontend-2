...
const Commentfromcontrol = memo((props) => {
  return (
    <Fragment>
      <div
        className="iq-social-comment-text position-relative d-flex align-items-center mt-3"
        action="#"
      >
...
Commentfromcontrol.displayName = "Commentfromcontrol";
export default Commentfromcontrol;
