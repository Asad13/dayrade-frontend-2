    ...
    <Fragment>
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div>
            <span className="badge bg-info d-inline-block rounded-pill">
              45
            </span>
          </div>
        </div>
        ...
        >
          <CustomToggle
            className="nav-link"
            eventKey="friend-list"
            active={activeMenu === "friend-list" ? true : false}
          ...
          <Accordion.Collapse eventKey="friend-list">
            <ul className="sub-nav">
              ...
              <SidebarMenu
                ...
                staticIcon="true"
                minititle="FR"
                pathname="/social/friend-requset"
              ...
              <SidebarMenu
                ...
                staticIcon="true"
                minititle="FP"
                pathname="/social/friend-profile"
          ...
          <Accordion.Collapse eventKey="Profile">
            <ul className="sub-nav">
              <SidebarMenu
                ...
                staticIcon="true"
                minititle="PB"
                pathname="/social/profile-badges"
              ...
              <SidebarMenu
                ...
                staticIcon="true"
                minititle="PI"
                pathname="/social/profile-images"
              ...
              <SidebarMenu
                ...
                staticIcon="true"
                minititle="A"
                pathname="/social/account-setting"
        ...
        <SidebarMenu
          isTag="false"
          minititle="SP"
          pathname="/social/social-profile"
