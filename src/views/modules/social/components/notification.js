                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div className="d-flex align-items-center gap-2">
                    <Link
                      ...
                      className={` iq-notify bg-${props.notificationcolor}-subtle rounded d-flex justify-content-center align-items-center p-1`}
                    >
                      ...
                      {props.notificationsvg === "4" && (
                        ...
                        >
                          <path
                            opacity="0.4"
                            d="M20 12.5645C17.5 7.56444 13.1667 6.73113 11 7.06447V13.0645C12.5 13.0645 15.9 13.3645 17.5 14.5645C18.7911 15.5328 20.603 17.8684 21.2546 18.7343C21.3177 18.8181 21.452 18.7632 21.435 18.6597C21.233 17.4306 20.5944 13.7532 20 12.5645Z"
                            fill="currentColor"
                          />
                          <path
                            d="M11.2053 16C11.0569 16 10.9107 15.9593 10.7814 15.88L2.37194 10.6625C2.14094 10.5185 2 10.2692 2 10C2 9.73086 2.14094 9.48151 2.37194 9.33754L10.7814 4.12003C11.0262 3.96876 11.3356 3.95937 11.5889 4.09813C11.8432 4.23584 12 4.49771 12 4.78252L12 15.2175C12 15.5024 11.8432 15.7642 11.5889 15.9019C11.4691 15.9677 11.3367 16 11.2053 16Z"
                            fill="currentColor"
                          />
                        </svg>
                      )}
                      {props.notificationsvg === "5" && (
                        ...
                        >
                          <path
                            d="M13 5.5C13 4.5 11.5 3 11.5 3C11.5 3 9.99997 4.5 10 5.5C10 6.47631 10.209 7.5 11.5 7.5C12.791 7.5 13 6.5 13 5.5Z"
                            fill="currentColor"
                          />
                          <path
                            opacity="0.4"
                            d="M10 11V8H13V11H10Z"
                            fill="currentColor"
                          />
                          <path
                            opacity="0.4"
                          ...
                          />
                          <path
                            d="M18.7916 11H4.23667C3.93831 11 3.6475 11.0938 3.40537 11.2681L2.84935 11.6685C1.93994 12.3232 1.93994 13.6768 2.84935 14.3315C3.40719 14.7332 4.15627 14.7445 4.72601 14.3599L4.96717 14.1972C5.60207 13.7686 6.42245 13.7281 7.09645 14.0921L7.59822 14.363C8.32332 14.7546 9.20587 14.711 9.88889 14.25C10.5719 13.789 11.4545 13.7454 12.1796 14.137L12.5982 14.363C13.3233 14.7546 14.2059 14.711 14.8889 14.25C15.5719 13.789 16.4545 13.7454 17.1796 14.137L17.8451 14.4964C18.4219 14.8079 19.1214 14.7867 19.6783 14.441C20.7847 13.7543 20.8392 12.1642 19.7825 11.4034L19.5717 11.2516C19.3445 11.088 19.0716 11 18.7916 11Z"
                            fill="currentColor"
                          />
                        </svg>
                      )}
