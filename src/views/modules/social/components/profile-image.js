  ...
  return (
    <Fragment>
      ...
      <div className="user-images position-relative overflow-hidden">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      opacity="0.4"
                      d="M3.5 12.5645C6 7.56444 10.3333 6.73113 12.5 7.06447V13.0645C11 13.0645 7.6 13.3645 6 14.5645C4.70893 15.5328 2.89695 17.8684 2.24538 18.7343C2.18231 18.8181 2.04803 18.7632 2.06504 18.6597C2.26701 17.4306 2.90561 13.7532 3.5 12.5645Z"
                      fill="currentcolor"
                    />
                    <path
                      d="M12.2947 16C12.4431 16 12.5893 15.9593 12.7186 15.88L21.1281 10.6625C21.3591 10.5185 21.5 10.2692 21.5 10C21.5 9.73086 21.3591 9.48151 21.1281 9.33754L12.7186 4.12003C12.4738 3.96876 12.1644 3.95937 11.9111 4.09813C11.6568 4.23584 11.5 4.49771 11.5 4.78252L11.5 15.2175C11.5 15.5024 11.6568 15.7642 11.9111 15.9019C12.0309 15.9677 12.1633 16 12.2947 16Z"
                      fill="currentcolor"
                    />
                  </svg>
                </Link>
        ...
        <Link
          to="#"
          className="image-edit-btn btn bg-white btn-sm btn-icon position-absolute"
