          ...
          <Card>
            <Card.Header className="align-items-center flex-wrap">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu aria-labelledby="dropdownMenuButton1">
                  <li>
                    <Dropdown.Item href="#">Everything</Dropdown.Item>
                  </li>
                  <li>
                    <Dropdown.Item href="#">Social</Dropdown.Item>
                  </li>
                  <li>
                    <Dropdown.Item href="#">Live Streming</Dropdown.Item>
                  </li>
                </Dropdown.Menu>
              </Dropdown>
            </Card.Header>
            <Card.Body>
              <Row className="row-cols-xl-4 row-cols-md-2 row-cols-1">
                ...
                <Col>
                  <StatisticsCards img={img2} header="Join" subHeader="100k" />
                </Col>
                <Col>
                  <StatisticsCards
                    img={img3}
        ...
        <Col lg="4">
          <Card>
            <Card.Header>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <span className="btn btn-sm btn-icon btn-primary-subtle text-primary rounded-pill">
                    3
                  </span>
                </div>
              </div>
            ...
            <Card.Body>
              <div className="d-flex mb-3 pb-3 border-bottom gap-3">
                <Image
                  src={img12}
                  alt="01"
                  className="img-fluid rounded-circle avatar-60"
                />
                <div>
          ...
          <Card>
            <Card.Body className="text-center">
                ...
                <Link to="#" className="iq-media-1">
                  <div className="icon">
                    <Image
                      src={img12}
                      alt="01"
                      className="rounded-circle avatar-50 img-fluid"
                    />
                  </div>
                </Link>
                <Link to="#" className="iq-media-1">
              ...
              <span className="mt-0">Active now on your profile</span>
            </Card.Body>
          </Card>
        </Col>
      </Row>
