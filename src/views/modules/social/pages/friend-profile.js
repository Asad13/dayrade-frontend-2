        ...
        <Col lg="4">
          ...
          <Card>
            <Card.Header className="d-flex justify-content-between">
              ...
              <div className="card-header-toolbar d-flex align-items-center">
                <p className="m-0">
                  <Link to="#javascript:void(0)">Add Photo </Link>
                </p>
              </div>
            </Card.Header>
            <Card.Body>
          ...
          <Card>
            <Card.Header className="d-flex justify-content-between">
              ...
              <div className="card-header-toolbar d-flex align-items-center">
                <p className="m-0">
                  <Link to="#javascript:void(0)">Add New </Link>
                </p>
              </div>
            </Card.Header>
            <Card.Body>
        ...
        <Col lg="8">
          <Card>
            ...
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-3">
                <div className="btn btn-sm btn-primary-subtle d-flex align-items-center">
                ...
                <div className="btn btn-sm btn-primary-subtle mx-3 d-flex align-items-center">
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="comment-area pt-3">
                <Likeshare noLikes="120" noComments="02" share="15" />
                <hr />
          ...
          <Card>
              ...
              <div className="header-title">
                <div className="d-flex justify-content-center flex-wrap">
                  <div className="media-support-user-img me-3">
                    <Image
                      className="img-fluid border border-2 border-primary border-dotted rounded-circle avatar-50 p-1"
                      src={friend4}
                      alt=""
                    />
                  </div>
                  <div className="media-support-info">
                    ...
                    <p className="mb-0 text-muted">10 hrs Ago</p>
                  </div>
                </div>
              </div>
              <Dropdown>
            ...
            <Card.Body>
              ...
              <div className="comment-area pt-3">
                <Likeshare noLikes="15" noComments="20" share="04" />
                <hr />
                <ul className="list-inline mt-4 mb-0">
                  <li className="mb-0">
                    <Friendcomment
