    ...
    <Fragment>
      <Card className="iq-product-custom-card animate:hover-media">
        <div className="iq-product-hover-img position-relative animate:hover-media-wrap">
          ...
          <div
            className="iq-product-card-hover-effect-1 iq-product-info"
            onClick={SweetalertOne}
          >
            <Button
              href="#"
              variant="icon iq-product-btn rounded-pill wishlist-btn"
            >
          ...
          <div className="iq-product-card-hover-effect-2 iq-product-info">
            <Button
              href="#"
              variant="icon iq-product-btn rounded-pill"
              onClick={Sweetalert}
            >
              <svg
                width="24"
          ...
          {props.statusDetails && (
            <div
              className={`iq-ribbon-effect text-primary ${props.statusColor}`}
            >
        ...
        <Card.Body>
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            {props.productRating && <span>{props.productRating}k Ratings</span>}
          </div>
        </Card.Body>
      </Card>
    </Fragment>
