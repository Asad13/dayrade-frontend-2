    ...
    <Fragment>
      <Card className="iq-product-list-view">
        <Card.Body className=" d-flex flex-wrap justify-content-between">
          <div className="iq-product-list-left-side d-flex gap-3 justify-content-center flex-wrap align-items-center trending-card">
            <Image
            ...
            <div className="iq-list-view-left text-center text-sm-start">
              <Link
                ...
                className="h5 mb-3 d-block iq-product-detail"
              >
                {props.productName}
              </Link>
              ...
              <div>
                <div className="d-flex align-items-center">
                  ...
                  <small className="ms-2">{props.productRating}k Review</small>
                </div>
              </div>
              <Counter />
            </div>
          ...
          <div className="iq-list-view-right d-flex flex-column justify-content-center align-items-end d-block align-items-center align-items-sm-end mx-sm-0 mx-auto">
            <div>
              <span
                className={`bg-${props.statusColor}-subtle badge rounded-pill p-2 px-3`}
              >
                {props.statusIdentity}
              </span>
            </div>
            ...
            <div className="iq-list-options d-flex align-items-end gap-2">
              <Button
                className="btn btn-info d-flex align-items-center cart-btn gap-2"
                onClick={Sweetalert}
              >
                <span>
                  <svg
