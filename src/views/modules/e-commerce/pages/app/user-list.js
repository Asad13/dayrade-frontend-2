...
const add = `  <svg className="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const edit = ` <svg className="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const remove = ` <svg className="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const tableData = [
  {
    ...
    contact: '<p class="text-dark">(208) 674-3424</p>',
    emailid: '<p class="text-dark">mist.e@mail.com</p>',
    country: {
      countrysvg: uae,
      countryname: '<span class="text-dark">UAE</span>',
    },
    purchases: '<span class="text-dark">327</span>',
    statustype: {
      statusColor: "warning",
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 346-4687</p>',
    emailid: '<p class="text-dark">c.mark@mail.com</p>',
    country: {
      countrysvg: jpn,
      countryname: '<span class="text-dark">JPN</span>',
    },
    purchases: '<span class="text-dark">324</span>',
    statustype: {
      statusColor: "success",
      status: "Complete",
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 555-0112</p>',
    emailid: '<p class="text-dark">dennis.e@mail.com</p>',
    country: {
      countrysvg: ind,
      countryname: '<span class="text-dark">IND</span>',
    },
    purchases: '<span class="text-dark">210</span>',
    statustype: {
      statusColor: "primary",
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 555-0112</p>',
    emailid: '<p class="text-dark">musk.e@mail.com</p>',
    country: {
      countrysvg: usa,
      countryname: '<span class="text-dark">USA</span>',
    },
    purchases: '<span class="text-dark">548</span>',
    statustype: {
      statusColor: "primary",
      bgColor: "primary-subtle",
      status: "Active",
  ...
  },
  {
    ...
    country: {
      countrysvg: grc,
      countryname: '<span class="text-dark">GRC</span>',
    },
    purchases: '<span class="text-dark">548</span>',
    statustype: {
      statusColor: "white",
  ...
  },
  {
    ...
    country: {
      countrysvg: sko,
      countryname: '<span class="text-dark">S.KO</span>',
    },
    purchases: '<span class="text-dark">548</span>',
    statustype: {
      statusColor: "success",
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 326-4679</p>',
    emailid: '<p class="text-dark">mason.j@mail.com</p>',
    country: {
      countrysvg: itl,
      countryname: '<span class="text-dark">ITL</span>',
    },
    purchases: '<span class="text-dark">481</span>',
    statustype: {
      statusColor: "white",
      bgColor: "primary",
      status: "Hold",
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 778-6878</p>',
    emailid: '<p class="text-dark">park.e@mail.com</p>',
    country: {
      countrysvg: ger,
      countryname: '<span class="text-dark">GER</span>',
    },
    purchases: '<span class="text-dark">123</span>',
    statustype: {
      statusColor: "danger",
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 262-238</p>',
    emailid: '<p class="text-dark">mclark@mail.com</p>',
    country: {
      countrysvg: spn,
      countryname: '<span class="text-dark">SPN</span>',
    },
    purchases: '<span class="text-dark">256</span>',
    statustype: {
      statusColor: "warning",
      bgColor: "warning-subtle",
      status: "Pending",
  ...
  const columns = useRef([
    {
     ...
     <div class="d-flex align-items-center">
       <img class="rounded img-fluid avatar-65 me-3" src="${row.img}" alt="" loading="lazy">
      <div class="media-support-info">
      <h5 class="iq-sub-label">${row.name}</h5>
    ...
    },
    {
      ...
      render: function (data) {
        return `${data.countrysvg} ${data.countryname}`;
      },
    },
    {
      title: "Purchases",
    ...
    },
    {
      ...
      render: function (row) {
        ...
        <a class="btn btn-primary btn-icon btn-sm rounded-pill" href = "/blog/blog-category" role = "button" >
          <span class="btn-inner"> ${row.actionadd}</span>
        </a>
        <div class="d-flex gap-3 justify-content-center">
          <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button">
            <span class="btn-inner">${row.actionedit}</span>
          </a>
          <div class="d-flex gap-3 justify-content-center">
            <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button">
              <span class="btn-inner">${row.actionremove}</span>
            </a>`;
      },
    },
  ]);
