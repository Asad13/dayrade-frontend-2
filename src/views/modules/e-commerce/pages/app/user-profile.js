              ...
              <Tab.Container defaultActiveKey="first">
                ...
                <Tab.Content>
                  ...
                  >
                    <div className="d-flex align-items-center justify-content-between flex-wrap">
                      ...
                      <div className="text-end pb-3">
                        <Dropdown>
                          ...
                          <Dropdown.Menu>
                            <Dropdown.Item href="#" active className="active">
                              Last 30 Days
                            </Dropdown.Item>
                    ...
                    <Card className="card shadow-none border iq-product-order-placed">
                      <div className="card-header user-details-bg-color bg-light p-4">
                        <div className="iq-order-content">
                          ...
                          <h6 className="mb-xl-0 mb-2 iq-order-id">
                            Order ID: <Link to="#"> #895-458895-125489</Link>
                          </h6>
                        </div>
                      </div>
                      <Card.Body>
                        <div className="d-flex align-items-center justify-content-between flex-wrap">
                          <div className="d-flex align-items-center">
                            <Image
                              src={img1}
                              alt="user-profile"
                              className="img-fluid rounded object-contain avatar-100 iq-product-bg p-3"
                            />
                            <div className="ms-3">
                              <Link to="/e-commerce/product-details">
                                <h5 className="mb-3">Biker’s Jacket</h5>
                              </Link>
                              <h6 className="text-primary mb-0">$45.99</h6>
                            </div>
                          </div>
                      ...
                      <div className="card-body">
                        <div className="d-flex align-items-center justify-content-between flex-wrap">
                          <div className="d-flex align-items-center">
                            ...
                            <div className="ms-3">
                              <Link to="/e-commerce/product-details">
                                <h5 className="mb-3">Pink Sweater</h5>
                              </Link>
                              <h6 className="text-primary mb-0">$26.00</h6>
                            </div>
                          </div>
                          <div className="mt-3 mt-xl-0 mt-3 mt-md-0">
                            <div className="text-end">
                  ...
                  >
                    <Row>
                      ...
                      <UserAccountCards
                        cardCass="default-card"
                        addressMode="Default"
                        userName="Elon Musk"
                        addressType="Home"
                        userContact="(303) 555-0105"
                        userAddress="265, Hill View, Rochester Avenue. Kentucky - 40062"
                      />
                      <UserAccountCards
                        cardCass="border iq-user-address"
                        userName="Christopher Nolan"
                        addressType="Office"
                        userContact="(+994) 569-05210"
                        userAddress="265, Hill View, Rochester Avenue. Kentucky - 40062"
                      />
                      <UserAccountCards
                        cardCass="border iq-user-address"
                      ...
                      />
                      <UserAccountCards
                        cardCass="border iq-user-address mb-0"
                        userName="Christopher Nolan"
                        addressType="Office"
                        userContact="(+994) 569-05210"
                        userAddress="265, Hill View, Rochester Avenue. Kentucky - 40062"
                            ...
                            >
                                ...
                                <Accordion.Header className="border-bottom">
                                  <div className="d-flex flex-grow-1 align-items center">
                                    <Image
                                      ...
                                      className="img-fluid"
                                    />
                                    <h6 className="ms-3 card-details mb-0">
                                      BOA Debit Card 0654
                                    </h6>
                                  </div>
                                  <div>
                              ...
                              >
                                <Accordion.Header className="border-bottom">
                                  ...
                                  <div>
                                    <h6 className="text-danger mx-2 mb-0">
                                      Expired 08/2021
                                    </h6>
                                  </div>
                                </Accordion.Header>
                        ...
                        <div className="d-flex align-items-center justify-content-center">
                          <div className="position-relative">
                            <Image
                              src={img8}
                              alt="user-profile"
                              className="img-fluid edit-img border border-white border-4 rounded-circle"
                            />
              ...
              <ul className="list-inline m-0 p-0">
                <li className="d-flex align-items-center mb-4 flex-wrap justify-content-center">
                  <div className="mb-0 mb-xl-0 mb-md-0 mb-lg-4">
                    <Image
                      src={img9}
                      alt="user-profile"
                      className="img-fluid rounded object-contain avatar-80 iq-product-bg"
                    />
                  </div>
                  <div className="flex-grow-1 ms-3">
                    <Link
                      to="/e-commerce/product-details"
                      className="h6 iq-product-detail"
                    >
                      Biker’s Jacket
                    </Link>
                    <h5 className="text-primary mt-2 mb-0">$45.99</h5>
                    <small className="mb-0">Buy on Jan 2021</small>
                  </div>
                  <Button
                    className="primary btn-icon btn-sm rounded-circle"
                ...
                <li className="d-flex align-items-center mb-4 flex-wrap justify-content-center">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <h5 className="text-primary mt-2  mb-0">$19.42</h5>
                    <small className="mb-0">Buy on Dec 2020</small>
                  </div>
                  <Button
                    className="primary btn-icon btn-sm rounded-circle"
                    to="/e-commerce/order-process"
                ...
                <li className="d-flex align-items-center mb-4 flex-wrap justify-content-center">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <h5 className="text-primary mt-2  mb-0">$26.00</h5>
                    <small className="mb-0">Buy on Jan 2021</small>
                  </div>
                  <Button
                    className="primary btn-icon btn-sm rounded-circle"
                ...
                <li className="d-flex align-items-center flex-wrap justify-content-center">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <h5 className="text-primary mt-2  mb-0">$19.99</h5>
                    <small className="mb-0">Buy on Jan 2021</small>
                  </div>
                  <Button
                    className="primary btn-icon btn-sm rounded-circle"
              ...
              <SwiperSlide className="card-slide">
                <Card>
                  <Card.Body>
                    ...
                    <div className="text-center">
                      <h6 className="text-primary">New Collection for you</h6>
