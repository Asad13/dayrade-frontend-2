                    ...
                    <Card>
                        <Card.Body>
                            <Row>
                                ...
                                <Col className="mt-4 mt-lg-0 col-lg-5">
                                    <div className="border-bottom">
                                        <div className="d-flex flex-column align-content-between justify-items-center mb-3">
                                            ...
                                            <div className=" d-flex align-items-center w-100">
                                                <svg className="icon-24" xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <Counter class="mb-3" />
                                    <div className="d-flex py-4 flex-wrap gap-3">
