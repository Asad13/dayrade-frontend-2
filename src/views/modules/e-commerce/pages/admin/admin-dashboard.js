...
import $ from "jquery";
// const generateStyledProfile = (name) => `<b style="color:#0B112E">${name}</b>`;
// const generateStyledRank = (rank) => `<b style="color:#8A92A6">${rank}</b>`;
// const generateStyledRevenue = (revenue) => `<b style="color:#8A92A6" >${revenue}</b>`;

// Data
const tableData = [
  {
    rank: "#101",
    profile: '<h6>Jacob Jones</h6><p class="mb-0">@jones</p>',
    revenue: "$25,916",
    sales: "4,863",
  },
  {
    rank: "#118",
    profile: '<h6>James Mason</h6> <p class="mb-0">@jamesM</p>',
    revenue: "$13,989",
    sales: "875",
  },
  {
    rank: "#148",
    profile: '<h6>Elon Musk</h6> <p class="mb-0">@musk</p>',
    revenue: "$14,437",
    sales: "1548",
  },
  {
    rank: "#179",
    profile: '<h6>Marie Clark</h6><p class="mb-0">@mclark</p>',
    revenue: "$8,015",
    sales: "752",
  },
];
              ...
              <Card className="bg-primary">
                ...
                <Card.Body>
                  ...
                  <h4 className="text-white counter mb-0">
                    $
                    <CountUp start={0} end={14434} duration={5} separator="," />
                  </h4>
                </Card.Body>
              </Card>
            </Col>
              ...
              <Card className="iq-fancy-card position-relative">
                <Card.Body>
                  <div className="text-center">
                    <div className="m-auto d-inline-block p-4 bg-primary-subtle rounded-pill">
                      <svg
                        width="44"
                        className="icon-44"
                        viewBox="0 0 24 24"
                  ...
                  <div className="d-flex align-items-center">
                    <Dropdown>
                      ...
                      <Dropdown.Menu aria-labelledby="dropdownMenuButton2">
                        <Dropdown.Item href="#">Profiles</Dropdown.Item>
          ...
          <Row>
            <Col lg="6" md="6">
              <Card>
                <Card.Header className="align-items-center">
                  ...
                  <Dropdown>
                    ...
                    >
                      ...
                      <Dropdown.Item href="#">Advertise</Dropdown.Item>
                      <Dropdown.Item href="#">
                ...
                <Card.Body>
                  <div className="d-flex selling-card align-items-center gap-4">
                    <Image
                      src={img5}
                      alt="user-profile"
                      className="img-fluid rounded bg-light w-50"
                    />
                    <div className="selling-details">
                      <h5 className="mb-3 text-gray">Jacket</h5>
            ...
            <Col lg="6" md="6">
              <Card>
                <Card.Header className="align-items-center">
                  <h4 className="mb-0">Most Viewed</h4>
                  <Dropdown>
                    <span role="button">
                      <Dropdown.Toggle
                        as="svg"
                ...
                <Card.Body>
                  <div className="d-flex selling-card align-items-center gap-4">
                    <Image
                      src={img6}
                      alt="user-profile"
                      className="img-fluid rounded me-3 me-sm-5 bg-light w-50"
                    />
                    <div className="selling-details">
                      <h5 className="mb-3 text-gray">Bags</h5>
                      <h4 className="mb-3">$56.00</h4>
                ...
                <li className="d-flex mb-4 align-items-center">
                  <div>
                    <Image
                      src={img7}
                      alt="story-img"
                      className="img-fluid rounded object-contain avatar-90 iq-product-bg"
                    />
                  </div>
                  <div className="ms-4">
                    <Link
                      to="/e-commerce/product-details"
                      className="h5 iq-product-detail"
                    >
                      Biker’s Jacket
                    </Link>
                    <div className="d-flex align-items-center">
