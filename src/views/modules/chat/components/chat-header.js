            ...
            <Card.Header className="border-bottom d-flex justify-content-between align-items-center rounded-0 p-3">
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="position-relative">
                        <Image src={props.userProfileImg} alt="users" className="img-fluid avatar-50 rounded-pill" loading="lazy" />
                        <div className={`${props.statusidentify === 'online' ? 'bg-success' : 'bg-danger' } iq-profile-badge `}></div>
                    </div>
                ...
                <Dropdown className=" d-inline-flex ms-auto">
                    <Dropdown.Toggle as="span" bsPrefix="text-body d-inline-flex" >
                        <svg width="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
