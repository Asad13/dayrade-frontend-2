...
const SignUp = memo(() => {
  return (
    <Fragment>
      ...
      >
        <Row className="row m-0 align-items-center justify-content-center vh-100 w-100">
          <Col md="6" lg="5">
            <Card className="my-4">
              <Card.Body>
                ...
                <div className="d-flex justify-content-center">
                  <ul className="list-group list-group-horizontal list-group-flush">
                    ...
                    <li className="list-group-item border-0 pb-0">
                      <Link to="#">
                        <Image src={img2} alt="gm" />
                      </Link>
                    </li>
                    <li className="list-group-item border-0 pb-0">
                      <Link to="#">
                        <Image src={img3} alt="im" />
                      </Link>
                    </li>
                    <li className="list-group-item border-0 pb-0">
                      <Link to="#">
                        <Image src={img4} alt="li" />
                      </Link>
                    </li>
                  </ul>
                </div>
                <p className="text-center">
                  ...
                  <Link to="/auth/simple/sign-in">Sign up</Link>
                </p>
              </Card.Body>
            </Card>
          </Col>
