          ...
          <Col lg="4" className="col-10 offset-lg-7 offset-1">
            <Card>
              <Card.Body>
                ...
                <Row className="d-flex justify-content-between">
                  <Col sm="12" md="6" className="form-group">
                    <Form.Label className="form-label" htmlFor="Emailid">
                      Email
                    </Form.Label>
                    <input
                      type="email"
                  ...
                  <div className="form-group col-sm-12 col-md-6">
                    <Form.Label className="form-label" htmlFor="Phone_NO">
                      Phone No.
                    </Form.Label>
                    <input
                      type="password"
                ...
                <Row className="d-flex justify-content-between">
                  <Col sm="12" md="6" className="form-group">
                    <Form.Label className="form-label" htmlFor="firstPassword">
                      Password
                    </Form.Label>
                    <input
                      type="email"
                ...
                <div className="text-center pb-3">
                  <input
                    ...
                    id="aggrement-hopeui"
                  />
                  <Form.Check.Label htmlFor="aggrement-hopeui">
                    I agree with the terms of use
                  </Form.Check.Label>
                </div>
                <div className="text-center pb-3">
                  <Button onClick={() => history('/auth/sign-in')}>Sign up</Button>
                </div>
                <p className="text-center">Or sign in with other accounts?</p>
                <div className="d-flex justify-content-center align-items-center gap-4 flex-wrap">
                  <Link to="#">
                    <Image src={img1} alt="fb" loading="lazy" />
                  </Link>
                  <Link to="#">
                    <Image src={img2} alt="gm" loading="lazy" />
                  </Link>
                  <Link to="#">
                    <Image src={img3} alt="im" loading="lazy" />
                  </Link>
                  <Link to="#">
                    <Image src={img4} alt="li" loading="lazy" />
                  </Link>
                </div>
                <p className="text-center">
                  Already have an Account{" "}
                  <Link to="/auth/sign-in" className="ms-2">
                    Sign up
                  </Link>
                </p>
              </Card.Body>
