...
const EmailData = memo((props) => {
  ...
  return (
    <Fragment>
      <li className="iq-unread" onClick={toggleShow}>
        <div className="d-flex align-self-center iq-unread-inner">
          ...
          <div className="iq-email-content">
            <Link to="#" className="iq-email-subject">
              {props.subjectName} -
              <span className="text-gray">{props.emailMessage}</span>
            </Link>
            <div className="iq-email-date text-gray">{props.mailTime}</div>
          </div>
