  ...
  return (
    <Fragment>
      <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <Nav.Item
          as="li"
          className={`${location.pathname === "/mail/email" ? "active" : ""}`}
        >
          <Link
            className={`${
        ...
        <Nav.Item as="li">
          <Nav.Link href="#">
            ...
            <div>
              <span className="badge bg-success d-inline-block rounded-pill">
                45
              </span>
            </div>
          </Nav.Link>
        </Nav.Item>
        <SidebarMenu isTag="true" pathname="#" title="Sent">
          <i className="icon">
            <svg
              width="20"
              className="icon-20"
        ...
        <SidebarMenu isTag="true" pathname="#" title="Drafts">
          <i className="icon">
            <svg
              width="20"
              className="icon-20"
