        ...
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div className="d-flex align-items-center">
              ...
              <h5 className="text-primary card-title ms-3 mb-0">
                Compose Message
              </h5>
            </div>
            {props.closeBtn && (
          ...
          <Form className="email-form">
            ...
            <Row className="form-group">
              <Form.Label htmlFor="subject" className="col-sm-2 col-form-label">
                Subject:
              </Form.Label>
              <Col sm="10">
            ...
            <Form.Group className="d-flex flex-wrap align-items-center justify-content-between mb-0">
              <div className="d-flex flex-wrap flex-grow-1 align-items-center">
                <div className="send-btn pl-3">
                  <Button role="button" className="btn-primary" to="#">
                    Send
                  </Button>
                </div>
                <div className="send-panel">
                  <Button variant="btn btn-icon btn-primary ms-2" to="#">
                    <span className="d-flex justify-content-center align-items-center">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M6.91211 14.1738C6.91211 14.1738 8.47733 17.0869 11.9991 17.0869C15.5208 17.0869 17.086 14.1738 17.086 14.1738"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        />
                  ...
                  <Button variant="btn btn-icon btn-primary ms-1" to="#">
                    <span className="d-flex justify-content-center align-items-center">
                      <svg
                        width="20"
                        className="icon-20"
                    ...
                    <span className="d-flex justify-content-center align-items-center">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M15.0402 4.05132C16.0502 4.45332 16.3592 5.85332 16.7722 6.30332C17.1852 6.75332 17.7762 6.90632 18.1032 6.90632C19.8412 6.90632 21.2502 8.31532 21.2502 10.0523V15.8473C21.2502 18.1773 19.3602 20.0673 17.0302 20.0673H6.9702C4.6392 20.0673 2.7502 18.1773 2.7502 15.8473V10.0523C2.7502 8.31532 4.1592 6.90632 5.8972 6.90632C6.2232 6.90632 6.8142 6.75332 7.2282 6.30332C7.6412 5.85332 7.9492 4.45332 8.9592 4.05132C9.9702 3.64932 14.0302 3.64932 15.0402 4.05132Z"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        ...
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M15.1789 13.128C15.1789 11.372 13.7559 9.94904 11.9999 9.94904C10.2439 9.94904 8.8209 11.372 8.8209 13.128C8.8209 14.884 10.2439 16.307 11.9999 16.307C13.7559 16.307 15.1789 14.884 15.1789 13.128Z"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <span className="d-flex justify-content-center align-items-center">
                      ...
                      >
                        ...
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M12.0003 12.9912C9.8426 12.9912 8 13.3174 8 14.6239C8 15.9304 9.83091 16.2684 12.0003 16.2684C14.1579 16.2684 16 15.9416 16 14.6356C16 13.3297 14.1696 12.9912 12.0003 12.9912Z"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        ...
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M11.9997 11.1277C13.4156 11.1277 14.5633 9.97954 14.5633 8.56359C14.5633 7.14764 13.4156 6 11.9997 6C10.5837 6 9.43556 7.14764 9.43556 8.56359C9.43078 9.97476 10.571 11.1229 11.9816 11.1277H11.9997Z"
                          stroke="currentColor"
                          strokeWidth="1.42857"
                          strokeLinecap="round"
                          strokeLinejoin="round"
              ...
              <div className="d-flex me-3 align-items-center mt-2 mt-sm-0">
                <div className="send-panel float-right">
                  <Button variant="btn btn-icon btn-primary me-1" to="#">
                    <span className="d-flex justify-content-center align-items-center">
                      <svg
                        width="20"
                        className="icon-20"
                  ...
                  <Button variant="btn btn-icon btn-primary" to="#">
                    <span className="d-flex justify-content-center align-items-center">
                      <svg
                        width="20"
                        className="icon-20"
                      ...
                      >
                        ...
                        />
                        <path
                          d="M17.4406 6.23967C16.6556 6.23967 15.9796 5.68467 15.8256 4.91567L15.5826 3.69967C15.4326 3.13867 14.9246 2.75067 14.3456 2.75067H10.1126C9.53361 2.75067 9.02561 3.13867 8.87561 3.69967L8.63261 4.91567C8.47861 5.68467 7.80261 6.23967 7.01761 6.23967"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
