...
const EmailCompose = memo((props) => {
  return (
    <Fragment>
      <div
        className={`email-app-details ${props.show ? "show" : ""}`}
      >
        <Card className="mb-0">
          <Card.Body>
            <div className="d-flex justify-content-between align-items-center">
              <div className="d-flex justify-content-between">
                <div
                  className="email-remove submit me-2 text-primary"
                ...
                <div className="me-2">
                  {props.stars === true ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      className="iq-star mx-2 icon-20"
                      viewBox="0 0 20 20"
                      fill="none"
                    >
                      <path
            ...
            <div className="d-flex justify-content-start mt-4">
              ...
              <div className="ms-2">
                <span>
                  {props.senderName}
                  <code className="m-0 iq-word-wrap">
                    {" "}
                    &#x3C;{props.senderName}.123@gmail.com&#x3E;&#x3C;/
                    {props.senderName}.123&#x3E;
                  </code>
                </span>
                <br />
                <div className="dropdown">
                  ...
                  <table
                    ...
                    aria-labelledby={`dropdownMenuLink-${props.id}`}
                  >
                    <tbody>
                      <tr>
                        <th>from:</th>
                        <td className="iq-word-wrap">
                          &#x3C;{props.senderName}.123@gmail.com&#x3E;
                        </td>
                      </tr>
                      <tr>
            ...
            <div>
              ...
              <p>
                ...
                egestas eu lacus, libero. Non mollis nunc commodo cursus urna
                pharetra aliquam. Est mi diam sed ac ut id. Metus gravida enim
                molestie sagittis condimentum interdum risus.{" "}
              </p>
            ...
            <div className="mt-3 mt-sm-0">
              <Button variant="md btn-primary me-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  className="icon-24"
