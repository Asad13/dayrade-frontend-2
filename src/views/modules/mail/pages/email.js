...
const Email = memo(() => {
  ...
  return (
    <Fragment>
      <div className="overflow-hidden">
        <Card>
          <Card.Body className="p-0">
            <div className="tab-bottom-bordered d-flex justify-content-between align-items-center flex-wrap pt-2 mail-data">
                ...
                <Nav as="ul" className="mb-0 pe-0 nav-tabs" role="tablist">
                  <Nav.Item as="li">
                    ...
                    >
                      ...
                      <span className="iq-mail-section ms-1">Primary</span>
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link
                    ...
                    >
                      ...
                      <span className="iq-mail-section ms-1">Social</span>
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link
                      eventKey="3"
                      data-bs-target="#tab-contact"
                    ...
                    >
                      ...
                      <span className="iq-mail-section ms-1">Promotions</span>
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
              ...
              >
                ...
                >
                  <ul className="iq-email-sender-list m-0">
                    <EmailData
                      id="1"
                      senderName="Library Books"
                      stars={true}
                      subjectName="Books you applied for are availabe"
                      mailTime="10:00 AM"
                      emailMessage="Adipiscing elit. sollicitudin fusce tellus elementum est orci lacinia. Habitant lectus risus orci pellentesqu..."
                    />
                    <EmailData
                      id="2"
                      senderName="Swiggy"
                      stars={true}
                      subjectName="Round trip around the world"
                      mailTime="1:16 PM"
                      emailMessage="Sollicitudin fusce tellus elementum est lacinia. Habitant lectus risus orci pellentesqu elementum tellus est lacinia..."
                    />
                    <EmailData
                      id="3"
                      senderName="Jane Cooper"
                      stars={true}
                      subjectName="It’s time to earn bigger rewards!"
                      mailTime="02:04 PM"
                      emailMessage="Lorem ipsum dolor sit amet, sollicitudin fusce tellus elementum est lacinia. Habitant lectus est pellentesq..."
                    />
                    <EmailData
                      id="4"
                      senderName="Wade Warren"
                      subjectName="Kick off the weekend with a cook-off"
                      mailTime="03:39 PM"
                      emailMessage=" Adipiscing elit.  sollicitudin fusce tellus elementum est lacinia. Habitant lectus risus orci pellentesqu..."
                    />
                    <EmailData
                      id="5"
                      senderName="Leslie Alexander"
                      stars={true}
                      subjectName="Check Out Top Companies Hiring Now!"
                      mailTime="03:58 PM"
                      emailMessage="Sollicitudin fusce tellus elementum est lacinia. Habitant lectus risus orci pellentesqu elementum tellus est lacinia..."
                    />
                    <EmailData
                      ...
                      senderName="Library Books"
                      stars={true}
                      subjectName="Your daily dose of handpicked stories"
                      mailTime="04:17 PM"
                      emailMessage="Sollicitudin fusce tellus elementum est lacinia. Habitant lectus risussce tellus elem orci pellentesqu..."
                    />
                    <EmailData
                      id="7"
                      senderName="Wipro Wilp"
                      stars={true}
                      subjectName="Data Is Where You Can Advance: Build the Career You’ve Wanted"
                      mailTime="07:23 AM"
                      emailMessage="Adipiscing elit. sollicitudin fusce tellus eleme lectus risus orci pellentesqu..."
                    />
                    <EmailData
                      id="8"
                      senderName="Jane Cooper"
                      stars={true}
                      subjectName="Statement of Accounts of Funds "
                      mailTime="07:46 AM"
                      emailMessage="Adipiscing elementum elit. sollicitudin fusce tellus elementum est lacinia. Habitant lectus risus tellusorci ..."
                    />
                    <EmailData
                      id="9"
                      senderName="Guy Hawkins"
                      subjectName="Smart careers and greater futures"
                      mailTime="09:03 AM"
                      emailMessage="Adipiscing elit. sollicitudin fusce tellus elementum est orci lacinia. Habitant lectus risus orci pellentesqu..."
                    />
                    <EmailData
                    ...
                    <EmailData
                      ...
                      subjectName="Data Is Where You Can Advance: Build the Career You’ve Wanted"
                      mailTime="11:42 AM"
                      emailMessage="Lorem ipsum dolor sit amet, sollicitudin fusce tellus elementum est lacinia. Habitant est pellentesq..."
                    />
                    <EmailData
                      id="13"
                      senderName="Wipro Wilp"
      ...
      <Modal
        className="iq-custom-mail-modal"
        size="lg"
        fullscreen="lg-down"
        show={show}
        onHide={handleClose}
