              ...
              <div className="d-flex flex-wrap align-items-center justify-content-between">
                <div className="d-flex flex-wrap align-items-center">
                  <div className="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                    <h4 className="me-2 h4">Hover Button</h4>
                  </div>
                </div>
                <small>
                  For more Information regarding hover button Plugin refer
                  <a href="https://ianlunn.github.io/Hover/#effects">
                    Documentation
                  </a>
                </small>
              </div>
      ...
      <Row>
        <Col lg="12">
          <Card>
            <Card.Header>
              <Card.Header.Title>
                <h4 className="mb-0">2D Transition</h4>
                <p>
        ...
        <Col lg="12">
          <Card>
            <Card.Header>
              <Card.Header.Title>
                <h4 className="mb-0">Background Transitions</h4>
                <p>
                  In this method, selecting only one option from a lots of
                  options while only using up as much space as a single option
                  excepted.
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className="btn btn-primary me-4  hvr-fade">
                  Fade
                </Button>
        ...
        <Col lg="12">
          <Card>
            <Card.Header>
              <Card.Header.Title>
                <h4 className="mb-0">Border Transitions</h4>
                <p>
                  In this method, selecting only one option from a lots of
                  options while only using up as much space as a single option
                  excepted.
        ...
        <Col lg="12">
          <Card>
            <Card.Header>
              <Card.Header.Title>
                <h4 className="mb-0">Shadow and Grow Transitions</h4>
                <p>
                  In this method, selecting only one option from a lots of
                  options while only using up as much space as a single option
                  excepted.
        ...
        <Col lg="12">
          <Card>
            <Card.Header>
              <Card.Header.Title>
                <h4 className="mb-0">Speech Bubbles</h4>
                <p>
                  In this method, selecting only one option from a lots of
                  options while only using up as much space as a single option
                  excepted.
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-top"
                >
                  Bubble Top
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-right"
                >
                  Bubble Right
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-bottom"
                >
                  Bubble Bottom
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-left"
                >
                  Bubble Left
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-float-top"
                >
                  Bubble Float Top
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-float-right"
                >
                  Bubble Float Right
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-float-bottom"
                >
                  Bubble Float Bottom
                </Button>
                <Button
                  href="#"
                  className="me-4 btn btn-primary hvr-bubble-float-left"
                >
                  Bubble Float Left
                </Button>
              </div>
