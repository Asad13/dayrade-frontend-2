        ...
        <Container>
          <Row className="row-cols-1">
            <Col>
              <Card>
                <Card.Body>
                  <Row className="row-cols-lg-2 row-cols-md-1">
                    <Image
                      src={image1}
                      alt="01"
                    ...
                    <div className="mt-5 mt-lg-0">
                      <h4 className="mb-4">Album</h4>
                      <h6 className="text-primary border-bottom pb-3 mb-0">
                        $15.00
                      </h6>
                      <p className="border-bottom py-3 mb-3">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus eleifend ultrices vestibulum tempor augue bibendum dolor quam malesuada.consectetur adipiscing elit.
                      </p>
                      <p className="mb-1">
                        <span className="text-primary ">SKU</span> : Woo-Album
                      </p>
                      <p>
                        <span className="text-primary pb-5">Category</span> :
                        Music
                      </p>
                      <div className="mt-4">
                        <div
                          className="btn-group iq-qty-btn"
                          data-qty="btn"
                          role="group"
                        >
                          <button
                            type="button"
                            className="btn btn-sm btn-outline-light iq-quantity-minus"
                          ...
                          <input
                            type="text"
                            className="btn btn-sm btn-outline-light input-display"
                            data-qty="input"
                            pattern="^(0|[1-9][0-9]*)$"
                            minLength="1"
                            value={cart}
                          ...
                          <button
                            type="button"
                            className="btn btn-sm btn-outline-light iq-quantity-plus"
                      ...
                      <div className="d-flex py-4 flex-wrap gap-4">
                        <Link to="#" className="btn btn-warning d-flex align-items-center gap-2">
                        ...
                        <Button variant="primary" className="btn btn-primary d-flex align-items-center cart-btn  gap-2">
                          <span className="btn-inner d-flex">
                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link to="#" className="btn btn-info d-flex align-items-center gap-2">
                          <span className="btn-inner d-flex ">
                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  >
                    <div className="d-flex flex-column">
                      ...
                      <p className="mb-0">
                        ...
                        Vestibulum Sagittis Orci Ac Odio Dictum Tincidunt. Donec
                        Ut Metus Leo. Class Aptent Taciti Sociosqu Ad Litora
                        Torquent Per Conubia Nostra, Per Inceptos Himenaeos. Sed
                        Luctus, Dui Eu Sagittis Sodales, Nulla Nibh Sagittis
                        Augue, Vel Porttitor Diam Enim Non Metus. Vestibulum
                        Aliquam Augue Neque. Phasellus Tincidunt Odio Eget
                        Ullamcorper Efficitur. Cras Placerat Ut Turpis
                        Pellentesque Vulputate. Nam Sed Consequat Tortor.
                        Curabitur Finibus Sapien Dolor. Ut Eleifend Tellus Nec
                        Erat Pulvinar Dignissim. Nam Non Arcu Purus. Vivamus Et
                        Massa Massa.
                      </p>
                    </div>
                  </div>
