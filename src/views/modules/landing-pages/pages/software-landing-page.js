...
// Image
import Image from "../../../../assets/modules/landing-pages/images/home-5/top-banner.webp";
import Image1 from "../../../../assets/modules/landing-pages/images/home-5/about-5.webp";
import image2 from "../../../../assets/modules/landing-pages/images/home-1/team1.webp";
import image3 from "../../../../assets/modules/landing-pages/images/home-1/team2.webp";
import image4 from "../../../../assets/modules/landing-pages/images/home-1/team-3.webp";
import image5 from "../../../../assets/modules/landing-pages/images/home-1/team-4.webp";
import image6 from "../../../../assets/modules/landing-pages/images/home-1/07.webp";
import image7 from "../../../../assets/modules/landing-pages/images/home-1/08.webp";
import image8 from "../../../../assets/modules/landing-pages/images/home-1/09.webp";
import image9 from "../../../../assets/modules/landing-pages/images/home-1/10.webp";
import image10 from "../../../../assets/modules/landing-pages/images/home-1/11.webp";
import Image11 from "../../../../assets/modules/landing-pages/images/home-1/04.webp";
import Image12 from "../../../../assets/modules/landing-pages/images/home-1/05.webp";
import Image13 from "../../../../assets/modules/landing-pages/images/home-1/06.webp";
import image14 from "../../../../assets/modules/landing-pages/images/home-2/user-1.webp";
import image15 from "../../../../assets/modules/landing-pages/images/home-2/user-2.webp";
import image16 from "../../../../assets/modules/landing-pages/images/home-2/user-3.webp";
import image17 from "../../../../assets/modules/landing-pages/images/home-1/12.webp";

const SoftwareLandingPage = memo(() => {
  return (
    <Fragment>
      <div className="inner-box bg-body">
        <Container>
          <Row className="align-items-center">
            <Col lg={6}>
            <div className="text-primary text-uppercase mb-2 sub-title">
                    Problem-solving Product
                </div>
              <h1 className="text-secondary mb-4 mb-lg-0 text-capitalize">
                We Build Products to<br /> {" "}
            ...
            <Col lg={6}>
              <p className="mb-4 mb-lg-5">
                ...
                vel sed in ac aliquam nisl sed. Non arcu quam aliquet amet,
                donec enim.{" "}
              </p>
            ...
            <Col lg={12} className="inner-box pb-0">
        ...
        <Container>
          <Row className="align-items-center">
            <Col md={5}>
              ...
              <h2 className="mb-4 mb-lg-5 text-capitalize">
                What are <span className="text-primary">we</span>
              </h2>
              <p className="mb-4 mb-lg-5">
              ...
              <div className="d-flex align-items-center mb-4 mb-lg-5">
                <div>
                  <h5 className="text-primary mb-2 fw-bold">100%</h5>
                  <p className="mb-0">Satisfaction</p>
                </div>
                <div className="ms-4">
                  <h5 className="text-primary mb-2 fw-bold">15k</h5>
                  <p className="mb-0">Downloads</p>
                </div>
                <div className="ms-4">
                  <h5 className="text-primary mb-2 fw-bold">24/7</h5>
            ...
            <Col md={7} className="mt-4 mt-lg-0">
        ...
        <Container>
          <Row>
            <Col lg={12} className="text-center">
              <div className="mb-2 text-uppercase text-primary sub-title">Features</div>
              <h2 className="mb-4 mb-lg-5 pb-4 pb-lg-5">
          ...
          <Row className="row-cols-1 row-cols-sm-2 row-cols-md-3">
            ...
            <Col>
              <Card className="feature-card card-block card-stretch card-height">
                <Card.Body>
                <svg className="mb-3" width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.4">
                                <path d="M20.1098 9.021C19.6052 9.021 18.9368 9.011 18.1046 9.011C16.075 9.011 14.4062 7.508 14.4062 5.675V2.459C14.4062 2.206 14.1793 2 13.9005 2H7.98876C5.22989 2 3 4.026 3 6.509V17.284C3 19.889 5.33613 22 8.21894 22H17.0212C19.7712 22 22 19.987 22 17.502V9.471C22 9.217 21.7742 9.012 21.4932 9.013C21.0217 9.016 20.454 9.021 20.1098 9.021Z" fill="#3A57E8"></path>
                                <path d="M20.1098 14.979C19.6052 14.979 18.9368 14.989 18.1046 14.989C16.075 14.989 14.4062 16.492 14.4062 18.325V21.541C14.4062 21.794 14.1793 22 13.9005 22H7.98876C5.22989 22 3 19.974 3 17.491V6.716C3 4.111 5.33613 2 8.21894 2H17.0212C19.7712 2 22 4.013 22 6.498V14.529C22 14.783 21.7742 14.988 21.4932 14.987C21.0217 14.984 20.454 14.979 20.1098 14.979Z" fill="#3A57E8"></path>
                            </g>
                            <path d="M8.50545 12.9067C8.06053 12.9067 7.70117 13.2801 7.70117 13.7423V16.9867C7.70117 17.4401 8.06053 17.8134 8.49689 17.8134C8.94181 17.8134 9.30117 17.4401 9.30117 16.9867V13.7423C9.30117 13.2801 8.94181 12.9067 8.50545 12.9067" fill="#3A57E8"></path>
                            <path d="M12.5965 9.28003C12.1601 9.28003 11.8008 9.65336 11.8008 10.1156V16.9867C11.8008 17.44 12.1601 17.8134 12.5965 17.8134C13.0414 17.8134 13.4008 17.44 13.4008 16.9867V10.1156C13.4008 9.65336 13.0414 9.28003 12.5965 9.28003" fill="#3A57E8"></path>
                            <path d="M16.6961 6C16.2597 6 15.9004 6.37333 15.9004 6.83556V16.9867C15.9004 17.44 16.2597 17.8133 16.6961 17.8133C17.141 17.8133 17.5004 17.44 17.5004 16.9867V6.83556C17.5004 6.37333 17.141 6 16.6961 6" fill="#3A57E8"></path>
                        </svg>
                  <FeatureWidget
        ...
        <Container>
          <Row className="align-items-center">
            <Col md={12} className="text-center">
              <div className="mb-2 text-white text-uppercase sub-title">Download now</div>
              <h2 className="mb-4 mb-lg-5 text-white text-capitalize">
                Fast, easy, and <span className="text-primary">Affordable</span>{" "}
              </h2>
              <p className="mb-4 mb-lg-5">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet at
                diam vivamus sodales <br/> magna suspendisse. Mi volutpat vel
                convallis sed risus egestas.
              </p>
              <div className="d-flex align-items-center justify-content-center pt-2">
                <Link to="#" className="btn btn-primary">
                  Try It For Free
                </Link>
                <Link to="#" className="btn btn-white custom-btn ms-2">
                  Buy Pro
                </Link>
              </div>
            </Col>
      ...
      <div className="section-card-padding bg-body">
        <Container>
          <Row className="align-items-center">
            <Col lg={12} className="text-center">
              <div className="mb-2 text-primary text-uppercase sub-title">Pricing</div>
              <h2 className="mb-4 mb-lg-5 pb-4 pb-lg-5 text-capitalize">
                Our <span className="text-primary">Price Plans</span>
              </h2>
            </Col>
          </Row>
          <Row className="row-cols-1 row-cols-md-2 row-cols-lg-4">
            <Col>
              <Card className="text-center">
                <div className="card-header bg-primary-subtle pb-4">
            ...
            <Col>
              <Card className="text-center">
                <div className="card-header bg-primary pb-4">
                  ...
                  <Link to="#" className="btn custom-btn btn-outline-light">
                    Get Started
                  </Link>
                </div>
                <Card.Body>
      ...
      <div className="section-padding">
        <Container>
          ...
          <Row className="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4">
          <Col >
        ...
        <Container>
          <Row className="align-items-center">
            ...
            >
              ...
              >
                <SwiperSlide className="swiper-slide card-slide  overflow-hidden mb-0">
                  <Card>
                    <TestimonialOne
              ...
              <div
                ...
                id="testimonial-one-next"
              ></div>
              <div
                className="swiper-button swiper-button-prev"
                id="testimonial-one-prev"
              ></div>
            </div>
          </Row>
        </Container>
      ...
      <div className="section-card-padding bg-body">
        <Container>
          <Row className="align-items-center">
            <Col md={12} className="text-center">
              <p className="mb-2 text-uppercase text-primary">Blog</p>
              <h2 className="text-secondary mb-4">
                All the <span className="text-primary">Support you Need</span>
              </h2>
            </Col>
            <div
              className="overflow-hidden slider-circle-btn mt-5"
              id="app-slider"
            >
              <Swiper
                className="p-0 m-0 mb-2 swiper-wrapper list-inline"
              ...
              >
                <SwiperSlide className="card-slide mb-0 overflow-hidde">
                  <Blog
                    blogImage={Image11}
      ...
      <div className="section-padding">
        <Container>
          <Row>
            ...
            <Col lg={7} xl={7} className="mt-4 mt-lg-0">
