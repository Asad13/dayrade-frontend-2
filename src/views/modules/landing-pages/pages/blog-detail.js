...
// image
import image from "../../../../assets//modules/blog/images/blog-avatar/01.png";
import image1 from "../../../../assets/modules/blog/images/blog-detail/01.png";
import image2 from "../../../../assets/modules/blog/images/blog-detail/05.png";
import image3 from "../../../../assets/modules/blog/images/blog-avatar/07.png";
import image4 from "../../../../assets/modules/blog/images/blog-avatar/08.png";
            ...
            <Col lg={8}>
              <Card>
                <Card.Body className="card-thumbnail">
                  <img
                    ...
                    loading="lazy"
                  />
                  <span className="text-primary sub-title mt-2">
                    02 Dec 2021
                  </span>
                  <div className="d-flex gap-3 mt-3">
                    <Link
                      to="../blog/blog-detail.html"
                  ...
                  <p>
                    ...
                    Neque at velit ultrices convallis. Purus sed adipiscing
                    hendrerit risus id dapibus tristique consectetur. Enim non
                    viverra massa sollicitudin arcu aliquam, sagittis aliquet
                    diam.
                  </p>
                  <h6 className="mt-3 mb-0">Through the States</h6>
                  <p className="mt-3">
                    Lorem ipsum dolor sit amet,{" "}
                    <span className="text-primary">consectetur</span> adipiscing
                    elit. Neque at velit ultrices convallis. Purus sed
                    adipiscing hendrerit risus id dapibus tristique consectetur.
                    Enim non viverra massa sollicitudin arcu aliquam, sagittis
                    aliquet diam.
                  </p>
                  ...
                  <h6 className="mt-4">To Travel Is To Live</h6>
                  <p className="mt-3">
                    Lorem ipsum dolor sit amet,{" "}
                  ...
                  <div className="d-flex justify-content-end">
                    <div className="me-4 d-flex align-items-center gap-2">
                      ...
                      <span className="fs-6 ">Comment</span>
                    </div>
              ...
              <Card>
                <div className="card-header">
                  <h5 className="card-title">Comment(3)</h5>
                </div>
                <Card.Body>
                      ...
                      <div className="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                        ...
                        <div>
                          <div className="d-flex justify-content-between align-items-center my-2 my-lg-0">
                            <h6 className="">Jackson Jones</h6>
                            <Link className="text-dark " to="#">
                              Reply
                            </Link>
                          </div>
                          <small className="text-primary sub-title">
                            March 01st 2021
                          </small>
                          <p className="mt-2 mb-0">
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Aliquam ut eu morbi tincidunt erat egestas
                            quisque ultrices ut. Vel elementum blandit et tellus
                            sit tincidunt.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="card shadow-none bg-transparent border ms-5">
                    <div className="card-body">
                      <div className="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                        <div>
                          <img
                  ...
                  <div className="card shadow-none bg-transparent border mb-0">
                    <div className="card-body">
                      <div className="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                        <div>
                          <img
              ...
              <Card>
                <Card.Body className="card-body">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="mb-3 text-primary fw-bold">Loren Banks</p>
                      <p className="mt-3">
              ...
              <Card>
                <Card.Body>
                  ...
                  <img
                    ...
                    loading="lazy"
                  />
                  <small className="text-primary sub-title mb-3">
                    April 19th 2021
                  </small>
                  <Link to="../blog/blog-detail.html" className="iq-title">
                    <h6 className="mt-2 mb-3">
                      5 Beauty Essentials Everyone Should Have in Their
                      Collection.
                    </h6>
                  </Link>
                ...
                <Card.Body>
                  ...
                  <div className="d-grid gap-3 grid-cols-2">
                    <Link to="#">
                      ...
                      <span className="text-body ms-1">Facebook</span>
                    </Link>
                    <Link to="#">
                      <svg
                        width="6"
                      ...
                      <span className="text-body ms-1">Instagram</span>
                    </Link>
                    <Link to="#">
                      <svg
                        width="6"
                      ...
                      <span className="text-body ms-1">Twitter</span>
                    </Link>
                    <Link to="#">
                      <svg
                        width="6"
                      ...
                      <span className="text-body ms-1">Youtube</span>
                    </Link>
                  </div>
                </Card.Body>
              </Card>
