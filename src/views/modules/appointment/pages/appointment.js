...
const tableData = [
  {
    user: { docimg: img1, name: "Elnora obrien" },
    email: "sara.cruz@example.com",
    contact: "(270) 555-0117",
    detail: "view",
  },
  {
    user: { docimg: img2, name: "Jonathan Bradley" },
    email: "kenzi.lawson@example.com",
    contact: "(319) 555-0115",
    detail: "view",
  },
  {
    user: { docimg: img3, name: "Katherine Romero" },
    email: "felicia.reid@example.com",
    contact: "(629) 555-0129",
    detail: "view",
  },
  {
    user: { docimg: img4, name: "Logan Wolfe" },
    email: "georgia.young@example.com",
    contact: "(603) 555-0123",
    detail: "view",
  },
  {
    user: { docimg: img5, name: "Oscar Phelps" },
...
const Appointment = memo(() => {
  ...
  const columns = useRef([
    {
      ...
      render: function (data) {
        return (
          '<div class="d-flex align-items-center"><img class="rounded img-fluid avatar-40 me-3" src=' +
          data.docimg +
          ' alt="profile" loading="lazy" /><h6 className="mb-0">' +
          data.name +
          "</h6></div>"
        );
      },
    ...
    },
    {
      ...
      data: "detail",
      render: function (data) {
        return '<a class="btn btn-link" href="#">' + data + "</a>";
      },
    },
  ]);
  ...
  if ($.fn.DataTable.isDataTable("#datatable-appoint")) {
    $("#datatable-appoint").DataTable().destroy();
  }
            ...
            <Card.Header className="flex-wrap align-items-center">
              ...
              <div className="d-flex align-items-center align-self-center mt-2 mt-sm-0">
                <div className="d-flex align-items-center text-primary">
                  ...
                  <div className="ms-2">
                    <span className="text-gray">Booked</span>
                  </div>
                </div>
                <div className="d-flex align-items-center ms-3 text-info">
                  ...
                  <div className="ms-2">
                    <span className="text-gray">Cancelled</span>
                  </div>
                </div>
              </div>
              <Dropdown>
                ...
                <Col md="5" sm="12">
                  <div className="d-flex flex-column">
                    <div className="d-flex align-items-center gap-2">
                      <svg
                        width="12"
                        className="text-primary icon-12"
                        viewBox="0 0 13 14"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
            ...
            <Card.Body>
              ...
              <div className="d-flex profile-media align-items-top">
                ...
                <div className="ms-4">
                  <h6 className="mb-1 ">
                    Brooklyn Simmons -{" "}
                    <span className="text-primary">Orthopedic</span>
                  </h6>
              ...
              <div className="d-flex profile-media align-items-top">
                ...
                <div className="ms-4">
                  <h6 className="mb-1 ">
                    Leslie Alexander -{" "}
                    <span className="text-primary">Neurology</span>
                  </h6>
              ...
              <div className="d-flex profile-media align-items-top">
                ...
                <div className="ms-4">
                  <h6 className="mb-1 ">
                    Robbin Doe - <span className="text-primary">ENT</span>
                  </h6>
              ...
              <div className="mb-1 d-flex profile-media align-items-top">
                ...
                <div className="ms-4">
                  <h6 className="mb-1 ">
                    Jane Cooper -{" "}
                    <span className="text-primary">Cardiologist</span>
                  </h6>
