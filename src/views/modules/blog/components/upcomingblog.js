        ...
        <Fragment>
            <Card className="mb-0">
                <Card.Body className="card-thumbnail">
                    <div className="d-flex align-items-center iq-upcoming-blogs gap-3">
                        <Image src={props.blogImage} alt="02" className="img-fluid object-cover rounded"/>
                        <div className="d-flex flex-column justify-content-center">
                            ...
                            <Link to="/pro/blog/blog-details">
                                <OverlayTrigger overlay={<Tooltip>{props.blogheader}</Tooltip>}>
                                    <h4 className="mt-2 mb-3 text-ellipsis short-1">{props.blogheader}</h4>
                                </OverlayTrigger>
                            </Link>
