...
const tableDatablog = [
  {
    ...
    desc: '<p class="text-dark">musk.e@mail.com</p>',
  ...
  },
  {
    ...
    desc: '<p class="text-dark">mclark@mail.com</p>',
    country: {
      countrysvg: spn,
  ...
  },
  {
    ...
    desc: '<p class="text-dark">mist.e@mail.com</p>',
    country: {
      countrysvg: uae,
  ...
  },
  {
    ...
    desc: '<p class="text-dark">c.mark@mail.com</p>',
    country: {
      countrysvg: jpn,
  ...
  },
  {
    ...
    contact: '<p class="text-dark">(208) 555-0112</p>',
    desc: '<p class="text-dark">dennis.e@mail.com</p>',
    country: {
      countrysvg: ind,
  ...
  },
  {
    ...
    desc: '<p class="text-dark">mason.j@mail.com</p>',
    country: {
      countrysvg: itl,
  ...
  },
  {
    ...
    desc: '<p class="text-dark">park.e@mail.com</p>',
    country: {
      countrysvg: ger,
...
const Blogcomments = memo(() => {
    ...
    },
    {
      ...
      render: function (row) {
        ...
        <a class="btn btn-primary btn-icon btn-sm rounded-pill" href = "/blog/blog-category" role = "button" >
          ...
          </a> <div class="d-flex gap-3 justify-content-center">
            <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button">
  ...
  const BlogtableRef = useRef(null);

  useDataTable({
    tableRef: BlogtableRef,
    columns: columns.current,
    data: tableDatablog,
  });

  if ($.fn.DataTable.isDataTable("#datatable-blogComme")) {
    $("#datatable-blogComme").DataTable().destroy();
  }
