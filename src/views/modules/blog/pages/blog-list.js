  ...
  return (
    <Fragment>
      ...
      <Row>
        <Col lg="8">
          <div className="mb-4">
            <p className="blog-line-around text-gray mb-0">
          ...
          <Col>
            <Topbloglist
              ...
              blogheader="The Ultimate Travel Guide: What To Do, See & Eat"
              blogsmall1="Food"
              blogsmall2="Brooklyn Simmons"
              blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."
            />
          ...
          <Col>
            <Topbloglist
              ...
              blogheader="WIT AND DELIGHT: The Advice From A Twenty Something"
              blogsmall1="Food"
              blogsmall2="Brooklyn Simmons"
              blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."
            />
          ...
          <Col>
            <Topbloglist
              blogImage={img15}
              blogDate="02 Dec 2021"
              blogheader="The Foreign and Domestic Culinary Adventures: An Art."
              blogsmall1="Food"
              blogsmall2="Brooklyn Simmons"
              blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."
            />
                ...
                <Col>
                  <Card>
                    <Card.Body className="card-thumbnail">
                      <Image
                        src={img2}
                        className="img-fluid rounded-top object-cover iq-top-categories"
                        alt="Top-Categories"
                      />
                      <div className="text-center">
                        <h5 className="text-ellipsis short-1">Food</h5>
                ...
                <Col>
                  <Card>
                    <Card.Body className="card-thumbnail">
                      ...
                      />
                      <div className="text-center">
                        <h5 className="text-ellipsis short-1">Travel</h5>
                ...
                <Col>
                  <Card>
                    <Card.Body className="card-thumbnail">
                      ...
                      />
                      <div className="text-center">
                        <h5 className="text-ellipsis short-1">Workspace</h5>
                ...
                <Col>
                  <Card>
                    <Card.Body className="card-thumbnail">
                      ...
                      />
                      <div className="text-center">
                        <h5 className="text-ellipsis short-1">Photography</h5>
