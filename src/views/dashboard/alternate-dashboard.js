              ...
              <Card data-aos="fade-up" data-aos-delay="900">
                ...
                <Card.Body>
                  <div className="flex-wrap d-flex align-items-center justify-content-between">
                    <Chart
                      className="col-md-8 col-lg-8 myChart"
                      options={chart2.options}
                      series={chart2.series}
                      type="radialBar"
                      height={chart2.options.chart.height}
                      style={{ minHeight: 208.7 }}
                    />
            ...
            <Col md={12} lg={12}>
              ...
              >
                ...
                <div className="card-body">
                  <div className="flex-wrap mb-4 d-flex justify-content-between align-itmes-center">
                    <div className="d-flex align-itmes-center me-0 me-md-4">
                      <div>
                        <div className="p-3 mb-2 rounded bg-primary-subtle">
                          <svg
                            width="20"
                            viewBox="0 0 24 24"
                            fill="none"
                    ...
                    <div className="d-flex align-itmes-center">
                      <div>
                        <div className="p-3 mb-2 rounded bg-info-subtle">
                          <svg
                            width="20"
                            viewBox="0 0 24 24"
                            fill="none"
