...
// image
import table1 from '../../../assets/images/shapes/01.png'
import table2 from '../../../assets/images/shapes/02.png'
import table3 from '../../../assets/images/shapes/03.png'
import table4 from '../../../assets/images/shapes/04.png'
import table5 from '../../../assets/images/shapes/06.png'
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              ...
                              <ProgressBar className={`bg-${item.color}-subtle mb-3`} now={item.now} variant={item.color} style={{ height: "6px" }} />
                            </td>
                          </tr>
                        )
                      })
