            ...
            <Card.Body>
              <div className="d-flex justify-content-start align-items-center">
                <div className="pe-3">
                  <Image
                    src={avatars3}
                    className="rounded-circle bg-primary-subtle p-1"
                    width="50"
                    height="50"
                    alt="1"
                  />
              ...
              <div className="d-flex justify-content-start align-items-center mt-4">
                <div className="pe-3">
                  <Image
                    src={avatars5}
                    className="rounded-circle bg-info-subtle p-1"
                    width="50"
                    height="50"
                    alt="1"
                  />
                    ...
                    <div className="d-flex flex-wrap">
                      <div className="user-img">
                        <Image
                          src={avatars3}
                          alt="userimg"
                          className="p-1 bg-primary-subtle avatar-60 rounded-circle img-fluid"
                        />
                      </div>
            ...
            <Card.Body>
              <div className="twit-feed">
                <div className="d-flex align-items-center mb-4">
                  <Image
                    className="theme-color-default-img  img-fluid avatar-60 me-3"
                    src={avatars11}
                    alt="profile-pic"
                  />
                  <Image
              ...
              <div className="twit-feed">
                <div className="d-flex align-items-center mb-4">
                  <Image
                    className="rounded-pill p-1 bg-primary-subtle img-fluid avatar-60 me-3"
                    src={avatars3}
                    alt=""
                  />
                  <div className="media-support-info">
