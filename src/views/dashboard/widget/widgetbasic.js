            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-end">
                  <h2 className="counter">
                    <CountUp start={565} end={5600} duration={3} separator="" />
                  </h2>
                  Doctors
                </div>
              </div>
          ...
          <Card className="bg-warning-subtle">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-end">
                  <h2 className="counter">
                    <CountUp start={513} end={5600} duration={3} separator="" />
                  </h2>
                  Nurses
                </div>
              </div>
          ...
          <Card className="bg-danger-subtle">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-end">
                  <h2 className="counter">
                    <CountUp start={584} end={3500} duration={3} separator="" />
                  </h2>
                  Patients
                </div>
              </div>
          ...
          <Card className="bg-primary-subtle">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-end">
                  <h2 className="counter">
                    <CountUp start={546} end={4500} duration={3} separator="" />
                  </h2>
                  Pharmacists
                </div>
              </div>
          ...
          <Card>
            <Card.Body>
              <h2 className="counter mb-3">
                $<CountUp start={495} end={3450} duration={3} separator="" />
              </h2>
              ...
              <div className="d-flex justify-content-between mt-3">
                <div>
                  <h2 className="counter mb-0   ">
                    <CountUp start={784} end={4500} duration={3} separator="" />
                  </h2>
                  <div>Operations</div>
                </div>
                <div>
