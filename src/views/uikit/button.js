          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/buttons"
                  target="_blank"
                >
                  <svg
                    width="20"
            ...
            <Tab.Content className="">
              ...
              >
                ...
                <div className="bd-example">
                  ...
                  <Button type="button" variant="dark-subtle text-white">
                    Dark
                  </Button>{" "}
                ...
                <div className="bd-example">
                  <Button type="button" variant="primary rounded-pill">
                    Primary
                  </Button>{" "}
                  <Button type="button" variant="secondary rounded-pill">
                    Secondary
                  </Button>{" "}
                  <Button type="button" variant="success rounded-pill">
                    Success
                  </Button>{" "}
                  <Button type="button" variant="danger rounded-pill">
                    Danger
                  </Button>{" "}
                  <Button type="button" variant="warning rounded-pill">
                    Warning
                  </Button>{" "}
                  <Button type="button" variant="info rounded-pill">
                    Info
                  </Button>{" "}
                  <Button type="button" variant="light rounded-pill">
                    Light
                  </Button>{" "}
                  <Button type="button" variant="dark rounded-pill">
                    Dark
                  </Button>{" "}
                  <Button type="button" variant="link rounded-pill">
                    Link
                  </Button>{" "}
                  <Button type="button" variant="gray rounded-pill">
                    Gray
                  </Button>
                </div>
                <div className="bd-example">
                  <Button type="button" variant="outline-primary rounded-pill">
                    Primary
                  </Button>{" "}
                  <Button
                    type="button"
                  ...
                  <Button type="button" variant="outline-success rounded-pill">
                    Success
                  </Button>{" "}
                  <Button type="button" variant="outline-danger rounded-pill">
                    Danger
                  </Button>{" "}
                  <Button type="button" variant="outline-warning rounded-pill">
                    Warning
                  </Button>{" "}
                  <Button type="button" variant="outline-info rounded-pill">
                    Info
                  </Button>{" "}
                  <Button type="button" variant="outline-light rounded-pill">
                    Light
                  </Button>{" "}
                  <Button type="button" variant="outline-dark rounded-pill">
                    Dark
                  </Button>{" "}
                  <Button type="button" variant="outline-gray rounded-pill">
                    Gray
                  </Button>
                </div>
                <div className="bd-example">
                  <Button type="button" variant="primary-subtle rounded-pill">
                    Primary
                  </Button>{" "}
                  <Button type="button" variant="secondary-subtle rounded-pill">
                    Secondary
                  </Button>{" "}
                  <Button type="button" variant="success-subtle rounded-pill">
                    Success
                  </Button>{" "}
                  <Button type="button" variant="danger-subtle rounded-pill">
                    Danger
                  </Button>{" "}
                  <Button type="button" variant="warning-subtle rounded-pill">
                    Warning
                  </Button>{" "}
                  <Button type="button" variant="info-subtle rounded-pill">
                    Info
                  </Button>{" "}
                  <Button type="button" variant="light-subtle rounded-pill">
                    Light
                  </Button>{" "}
                  <Button
                    type="button"
                    variant="dark-subtle text-white rounded-pill"
                  >
                    Dark
                  </Button>{" "}
                  <Button type="button" variant="gray-subtle rounded-pill">
                    Gray
                  </Button>
                </div>
                <div className="bd-example">
                ...
                <div className="bd-example">
                  ...
                  <Button variant="dark-subtle text-white rounded-pill">
                    <span className="btn-inner">
                      <svg
                        width="20"
                        fill="none"
                ...
                <div className="bd-example">
                  <Button
                    type="button"
                    variant="primary btn-icon rounded-pill"
                    size="sm"
                  >
                    <span className="btn-inner">
                      <svg
