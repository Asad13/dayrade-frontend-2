                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/ribbon" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        ...
                        <Tab.Content className="mt-2">
                            <Tab.Pane eventKey="first" className="tab-pane bd-heading-1 fade show active" id="content-ribbon-prv" role="tabpanel">
                                <div className="bd-example">
                                    <div className="bg-gray position-relative rounded" style={{ height: '200px' }}>
                                        <div className="iq-ribbon-effect text-primary">
                                            <span>New</span>
                                        </div>
                                        <div className="iq-ribbon-effect text-success iq-rtl-effect" style={{ marginLeft: '5rem' }}>
                                            <span>Discount</span>
                                        </div>
                                        <div className="iq-ribbon-effect text-danger iq-rtl-effect-offer" style={{ marginLeft: '10rem' }}>
