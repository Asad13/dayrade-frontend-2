...
//React-bootstrap
import { Row, Col, Badge, Nav, Tab, Button } from "react-bootstrap";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/badge"
                  target="_blank"
                >
                  <svg
                    width="20"
            ...
            <Tab.Content>
              ...
              >
                ...
                <div className="bd-example">
                  <Row>
                    ...
                    <Col sm="3">
                      <Button
                        type="button"
                        variant="primary position-relative mt-2 mt-sm-0"
                      >
                        Profile
                ...
                <div className="bd-example">
                  ...
                  <Badge pill bg="danger-subtle">
                    Danger
                  </Badge>{" "}
                  <Badge pill bg="warning-subtle">
                    Warning
                  </Badge>{" "}
                  <Badge pill bg="info-subtle">
                    Info
                  </Badge>{" "}
                  <Badge pill bg="light-subtle text-dark">
                    Light
                  </Badge>{" "}
                  <Badge pill bg="dark-subtle text-white">
                    Dark
                  </Badge>
                </div>
                <div className="bd-example">
                  ...
                  <span className="bg-secondary-subtle rounded-pill iq-custom-badge ">
                    Secondary
                    <Button variant="btn btn-gray btn-sm rounded-pill iq-cancel-btn">
                      <svg
                        className="icon-14"
                        width="14"
                        height="14"
                  ...
                  <span className="bg-success-subtle rounded-pill iq-custom-badge mt-1 mt-sm-0">
                    Success
                  ...
                  <span className="bg-warning-subtle rounded-pill iq-custom-badge mt-1 mt-sm-0">
                    Warning
                  ...
                  <span className="bg-danger-subtle rounded-pill iq-custom-badge mt-1 mt-sm-0">
                    Danger
                ...
                <div className="bd-example">
                  <span className="bg-primary-subtle rounded iq-custom-badge">
                    Primary
                    <Button variant="primary btn-sm rounded iq-cancel-btn">
                      <svg
                        className="icon-14"
                        width="14"
                        height="14"
                  ...
                  <span className="bg-secondary-subtle rounded iq-custom-badge">
                    Secondary
                    <Button variant="secondary btn-sm rounded iq-cancel-btn">
                      <svg
                        className="icon-14"
                        width="14"
                        height="14"
                  ...
                  <span className="bg-success-subtle rounded iq-custom-badge mt-1 mt-sm-0 ">
                    Success
                    <Button variant="success btn-sm rounded iq-cancel-btn">
                      <svg
                        className="icon-14"
                        width="14"
                        height="14"
                  ...
                  <span className="bg-warning-subtle rounded iq-custom-badge mt-1 mt-sm-0 ">
                    Warning
                    <Button variant="warning btn-sm rounded iq-cancel-btn">
                      <svg
                        className="icon-14"
                        width="14"
                        height="14"
                  ...
                  <span className="bg-danger-subtle rounded iq-custom-badge mt-1 mt-sm-0 ">
                    Danger
                    <Button variant="danger btn-sm rounded iq-cancel-btn">
                      <svg
                        className="icon-14"
                        width="14"
                        height="14"
...
<div className="bd-example">
    <span  className="bg-soft-primary rounded-pill iq-custom-badge">
        Primary
        <Button variant="primary btn-sm rounded-pill iq-cancel-btn">
