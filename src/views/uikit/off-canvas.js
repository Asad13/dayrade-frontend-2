...
const OffCanvass = memo(() => {
  ...
  return (
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/offcanvas"
                  target="_blank"
                >
                  <svg
                    width="20"
            ...
            <Tab.Content>
              ...
              >
                <div className="bd-example">
                  ...
                  <Button variant="primary mt-2" onClick={handleShow6}>
                  ...
                  <Button variant="primary mt-2" onClick={handleShow9}>
                  ...
                  <Offcanvas show={show9} onHide={handleClose9} scroll={true}>
                    ...
                    <Offcanvas.Body>
                      <p>
                        ...
                        longer than the prefedined max-height of modal, content
                ...
                <div className="section-block">
                  <pre className="language-markup">
                    <code className="language-markup">
                      {`<div className="bd-example">
    <Button variant="primary mt-2 me-1" onClick={handleShow5}>
        Toggle top offcanvas
    </Button>
    ...
    <Button variant="primary mt-2 me-1" onClick={handleShow6}>
        Toggle right offcanvas
    </Button>
    ...
    <Button variant="primary mt-2 me-1" onClick={handleShow7}>
        Toggle bottom offcanvas
    </Button>
    ...
    <Button variant="primary mt-2 me-1" onClick={handleShow8}>
        Toggle Left offcanvas
    </Button>
    <Offcanvas show={show8}  onHide={handleClose8}>
        <Offcanvas.Header closeButton>
    ...
    <Button variant="primary mt-2 me-1" onClick={handleShow9} >
        Toggle Scroll offcanvas
    </Button>
    <Offcanvas show={show9}  onHide={handleClose9} scroll={true}>
        <Offcanvas.Header closeButton>
