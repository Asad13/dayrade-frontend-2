          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/modal"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <div className="bd-example">
                  <div className="flex-wrap d-flex align-items-center">
                    ...
                    <Button variant="primary me-2" onClick={handleShow1}>
                    ...
                    <Button variant="primary me-2" onClick={handleShow3}>
                    ...
                    {values.map((v, idx) => (
                      <Button key={idx} onClick={() => handleShow4(v)}>
                        Full screen
