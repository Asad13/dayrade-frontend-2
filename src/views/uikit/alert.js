  ...
  return (
    <Fragment>
      <article id="alerts">
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/alert"
                  target="_blank"
                >
                  <svg
                    width="20"
        ...
        <Card className="card iq-document-card">
              ...
              >
                <Nav.Item className="" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-alert-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    className="d-flex align-items-center "
                    data-bs-toggle="tab"
                    data-bs-target="#content-alert-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content>
              ...
              >
                <div className="bd-example">
                  <Alert
                  show={showA1}
                    className=" alert-solid alert-primary alert-dismissible fade show"
                    role="alert"
                ...
                <div className="bd-example">
                  ...
                  >
                    <svg
                      className="flex-shrink-0 bi me-2"
                      width="24"
                      height="24"
                    >
                      <use href="#info-fill" />
                ...
                <div className="bd-example">
                  ...
                  <Alert
                    variant="info alert-top alert-dismissible fade show mb-3"
                    role="alert"
                    show={showA4}
                  ...
                  <Alert
                    variant="warning alert-right alert-dismissible fade show mb-3"
                    role="alert"
                    show={showA5}
                  ...
                  <Alert
                    variant="danger alert-bottom alert-dismissible fade show"
                    role="alert"
                    show={showA6}
...
<div className="bd-example">
    <Alert variant="success alert-left alert-dismissible fade show mb-3" role="alert" show={showA3} onClose={() => setShowA3(false)} >
        <span> This is a success alert—check it out!</span>
    </Alert>
    <Alert variant="info lert-top alert-dismissible fade show mb-3" role="alert" show={showA4} onClose={() => setShowA4(false)} >
        <span> This is a info alert—check it out!</span>
    </Alert>
    <Alert variant="warning right alert-dismissible fade show mb-3" role="alert" show={showA5} onClose={() => setShowA5(false)}>
        <span> This is a warning alert—check it out!</span>
    </Alert>
    <Alert variant="danger bottom alert-dismissible fade show" role="alert" show={showA6} onClose={() => setShowA6(false)} >
        <span> This is a danger alert—check it out!</span>
    </Alert>
</div>
<div className="bd-example">
    <Alert variant="warning rounded-0 alert-dismissible fade show " role="alert" show={showA7} onClose={() => setShowA7(false)}>
        <span> This is a warning alert—check it out!</span>
    </Alert>

    <Alert variant="warning alert-solid rounded-0 alert-dismissible fade show " role="alert" show={showA8} onClose={() => setShowA8(false)} >
        <span> This is a warning alert—check it out!</span>
    </Alert>
</div>
<div className="bd-example">
