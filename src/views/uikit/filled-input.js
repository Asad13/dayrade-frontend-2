...
const FilledInput = memo(() => {
    return (
        <Fragment>
            <article id="filled-input">
                <div className="mt-4 mb-3 bd-heading sticky-xl-top align-self-start mt-xl-0 mb-xl-2">
                    <Card>
                        <Card.Body>
                            <h5>Filled Input</h5>
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/alternate-input" target="_blank">
                        ...
                        <Tab.Content className="mt-2">
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-alternet-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <Form.Group className="form-group form-group-filled">
                                        <Form.Control type="text" className="" placeholder="Enter Text" />
                                    </Form.Group>
                                    <Form.Group className=" input-group form-group form-group-filled">
