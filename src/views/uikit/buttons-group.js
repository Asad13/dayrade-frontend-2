...
const ButtonGroups = memo(() => {
  ...
  const [counter1, setCount1] = useState(6);
  const [counter2, setCount2] = useState(1);
  const increase = () => setCount(counter + 1);
  const increase1 = () => setCount1(counter1 + 1);
  const increase2 = () => setCount2(counter2 + 1);
  const decrease = () => setCount(counter > 1 ? counter - 1 : 1);
  const decrease1 = () => setCount1(counter1 > 1 ? counter1 - 1 : 1);
  const decrease2 = () => setCount2(counter2 > 1 ? counter2 - 1 : 1);
          ...
          <Card className="">
            <Card.Body className="">
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/buttongroup"
                  target="_blank"
                >
                  <svg
                    width="20"
          ...
          <Tab.Container defaultActiveKey="first">
            ...
            <Tab.Content>
              ...
              >
                ...
                <div className="bd-example">
                  <div
                    className="btn-group iq-qty-btn me-4"
                    data-qty="btn"
                    role="group"
                  >
                    <Button
                      variant="outline-gray iq-quantity-minus"
                      size="sm"
                      onClick={decrease}
                    >
                      <svg
                    ...
                    <input
                      type="text"
                      data-qty="input"
                      className="btn btn-sm btn-outline-gray input-display"
                      readOnly
                      value={counter}
                      title="Qty"
                      placeholder=""
                    />
                    <Button
                      variant="outline-gray iq-quantity-plus"
                      size="sm"
                      onClick={increase}
                    >
                      <svg
                  ...
                  <div
                    className="btn-group iq-qty-btn me-4 mt-1 mt-sm-0"
                    data-qty="btn"
                    role="group"
                  >
                    <Button
                      variant="outline-light iq-quantity-minus"
                      size="sm"
                      onClick={decrease2}
                    >
                      <svg
                    ...
                    />
                    <Button
                      variant="outline-light iq-quantity-plus"
                      size="sm"
                      onClick={increase2}
                    >
                      <svg
...
<div className="bd-example">
    ...
    <div className="btn-group iq-qty-btn me-4" data-qty="btn" role="group">
        <Button variant="outline-gray iq-quantity-minus" size="sm" onClick={decrease}>
            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="3" viewBox="0 0 6 3" fill="none">
                <path d="M5.22727 0.886364H0.136364V2.13636H5.22727V0.886364Z" fill="currentColor"></path>
            </svg>
        </Button> 
        <input type="text" data-qty="input" className="btn btn-sm btn-outline-gray input-display" disabled value={counter}  title="Qty" placeholder=""/>
        <Button variant="outline-gray iq-quantity-plus" size="sm" onClick={increase}>
            <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8" viewBox="0 0 9 8" fill="none">
                <path d="M3.63636 7.70455H4.90909V4.59091H8.02273V3.31818H4.90909V0.204545H3.63636V3.31818H0.522727V4.59091H3.63636V7.70455Z" fill="currentColor"></path>
            </svg>
        </Button>
    </div>
    <div className="btn-group iq-qty-btn me-4 mt-1 mt-sm-0" data-qty="btn" role="group">
