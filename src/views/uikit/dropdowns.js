          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/dropdowns"
                  target="_blank"
                >
                  <svg
                    width="20"
            ...
            <Tab.Content>
              ...
              >
                <div className="bd-example">
                  <div className="flex-wrap btn-group w-100 align-items-center mt-0">
...
<div className="bd-example">
    ...
    {/* <!-- /btn-group --> */}
    <Dropdown as={ButtonGroup}>
        <Button type="button" variant="gray">Secondary</Button>
        <Dropdown.Toggle as={Button} type="button" split variant="gray">
            <span className="visually-hidden">Toggle Dropdown</span>
        </Dropdown.Toggle>
        <Dropdown.Menu>
            <Dropdown.Item href="#">Action</Dropdown.Item>
