import React, { useEffect, memo, Fragment, createRef } from "react";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/scrollspy"
                  target="_blank"
                >
                  <svg
                    width="20"
                    ...
                    <ul className="nav nav-pills">
                      ...
                      <NavDropdown title="Dropdown">
                        <NavDropdown.Item
                          ...
                          eventKey="#scrollspyHeading3"
                        >
                          Third
                        </NavDropdown.Item>
                        <NavDropdown.Item
                          href="#scrollspyHeading4"
                          eventKey="#scrollspyHeading4"
                        >
                          Fourth
                        </NavDropdown.Item>
                        <NavDropdown.Divider />
