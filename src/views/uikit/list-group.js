...
const ListGroups = memo(() => {
  return (
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/listgroup"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <div className="bg-example">
                  <ListGroup as="ul">
                    ...
                    <ListGroup.Item disabled>A second link item</ListGroup.Item>
                    ...
                    <ListGroup.Item>A disabled link item</ListGroup.Item>
                  </ListGroup>
                </div>
                ...
                <div className="bd-example">
                  <ListGroup>
                    ...
                    <ListGroupItem href="#" action variant="dark text-white">
                      A simple dark list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="gray text-white">
    ...
    <div className="bd-example">
    <ListGroup>
        <ListGroupItem className="list-group-item-action active" aria-current="true">
            <div className="d-flex w-100 justify-content-between">
                <h5 className="mb-1">List group item heading</h5>
                <small>3 days ago</small>
            </div>
