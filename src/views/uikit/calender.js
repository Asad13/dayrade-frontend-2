          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/datepicker"
                  target="_blank"
                >
                  <svg
                    width="20"
                  ...
                  <Col md="6" className="order-md-1">
                    ...
                    <div className="bd-example">
                      <div className="form-group d-flex">
                        ...
                        />
                        <Link
                          className="input-group-text input-button pointer-event"
                          title="toggle"
                          data-bs-toggle=""
                          to="#"
                        >
