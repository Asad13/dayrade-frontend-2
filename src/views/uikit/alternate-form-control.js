          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/alternate-input"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <Nav.Item as="li" className="" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-alternet-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" className="" role="presentation">
                  <Nav.Link
                    ...
                    className=" d-flex align-items-center"
                    data-bs-toggle="tab"
                    data-bs-target="#content-alternet-code"
                    type="button"
                    role="tab"
