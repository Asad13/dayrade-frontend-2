            ...
            <article id="popovers">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/popovers" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-Popover-prv" role="tabpanel" aria-labelledby="typo-output">
                            ...
                            <Tab.Pane eventKey="second" className=" bd-heading-1 fade show" id="content-Popover-code" role="tabpanel" aria-labelledby="typo-output">
