          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/pro/documentation/react/progress"
                  target="_blank"
                >
                  <svg
                    width="20"
            ...
            <Tab.Content className="mt-2">
              ...
              >
                <div className="bd-example">
                  <ProgressBar className="mb-3" now={5} label={`0%`} />
                  <ProgressBar
...
Progresss.displayName = "Progresss";
