            ...
            <article id="tooltips">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/tooltips" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-Tooltips-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-Tooltips-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-Tooltips-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example tooltip-demo">
                                    ...
                                    <OverlayTrigger placement="right" overlay={
                                        ...
                                        <Button variant="gray mt-2">Tooltip on end</Button>
                                    </OverlayTrigger>{' '}
                                    ...
                                    <OverlayTrigger placement="left" overlay={
                                        ...
                                        <Button variant="gray mt-2">Tooltip on start</Button>
                                    </OverlayTrigger>
                                    <OverlayTrigger placement="top" overlay={
                                        <Tooltip >
                            ...
                            <Tab.Pane eventKey="second" className=" bd-heading-1 fade show" id="content-Tooltips-code" role="tabpanel" aria-labelledby="typo-output">
